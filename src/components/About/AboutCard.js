            ...
            <Card.Body>
                <blockquote className="blockquote mb-0">
                    <p style={{ textAlign: "justify" }}>
                        ...
                        from <span className="purple"> Dhaka, Bangladesh.</span> I am {age} years old and completed my{" "}
                        ...
                        <br />
                        Currently I am working as a Software Engineer at <span className="purple">Bioforge System LTD</span>, which is a Biomedical
